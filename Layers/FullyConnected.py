...
class FullyConnected:
    ...
    def forward(self, input_tensor):
        ...
        input_tensor (numpy.ndarray) - input to the fully connected layer
        
        returns: 
        
        output_tensor (numpy.ndarray) - output from the layer during the forward pass computation for the next layer
    ...
    def backward(self, error_tensor):
        ...
        error_tensor (numpy.ndarray) - error signal received by the layer during the backward pass
        
        returns: 
        
        new_error_tensor (numpy.ndarray) - error signal for the previous layer in the network during the backward pass
